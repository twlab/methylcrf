...
//#include<math.h> #include<limits.h> #include<iostream.h>
#include<cmath> 
#include<climits> 
#include<iostream>
...
#endif
#ifndef MAX_ULONG
#define MAX_ULONG ULONG_MAX // some architechturs define INT_MAX not MAX_INT
#endif
...
public:
  Interval();
  virtual ~Interval();
  virtual unsigned long GetLowPoint() const = 0;
  virtual unsigned long GetHighPoint() const = 0;
...
protected:
  ...
  unsigned long red; /* if red=0 then the node is black */
...
public:
  ...
  TemplateStack<void *> * Enumerate(unsigned long low, unsigned long high) ;
