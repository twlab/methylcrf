...
mapBed -b $dip -a $cpg -o sum -null 0 |awk '{OFS="\t";$4=".";$5=$NF;NF=6;print}' > $dipreadbed  # test temp
ls -l $dipreadbed >&2
...
mapBed -b $cpg -a $dip -o count | awk '{OFS="\t";$5=$NF;NF=5;print}' > $dipcpgbed  # test temp
